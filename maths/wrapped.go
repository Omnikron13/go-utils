...
func Acos[T Rational](x T) float64 {
   return math.Acos(float64(x))
}

// Acosh returns the inverse hyperbolic cosine of x.
func Acosh[T Rational](x T) float64 {
   return math.Acosh(float64(x))
}

// Asin returns the arcsine, in radians, of x.
func Asin[T Rational](x T) float64 {
   return math.Asin(float64(x))
}

// Asinh returns the inverse hyperbolic sine of x.
func Asinh[T Rational](x T) float64 {
   return math.Asinh(float64(x))
}

// Atan returns the arctangent, in radians, of x.
func Atan[T Rational](x T) float64 {
...
func Atan2[T Rational](y, x T) float64 {
   return math.Atan2(float64(y), float64(x))
}

// Atanh returns the inverse hyperbolic tangent of x.
func Atanh[T Rational](x T) float64 {
...
func Cosh[T Rational](x T) float64 {
   return math.Cosh(float64(x))
}

// Erf returns the error function of x.
func Erf[T Rational](x T) float64 {
   return math.Erf(float64(x))
}

// Erfc returns the complementary error function of x.
func Erfc[T Rational](x T) float64 {
   return math.Erfc(float64(x))
}

// Erfcinv returns the inverse of Erfc(x).
func Erfcinv[T Rational](x T) float64 {
   return math.Erfcinv(float64(x))
}

// Erfinv returns the inverse error function of x.
func Erfinv[T Rational](x T) float64 {
   return math.Erfinv(float64(x))
}

// Exp returns e**x, the base-e exponential of x.
func Exp[T Rational](x T) float64 {
   return math.Exp(float64(x))
}

// Exp2 returns 2**x, the base-2 exponential of x.
func Exp2[T Rational](x T) float64 {
   return math.Exp2(float64(x))
}

// Expm1 returns e**x - 1, the base-e exponential of x minus 1.
func Expm1[T Rational](x T) float64 {
...
func IsNaN[T Rational](f T) bool {
   return math.IsNaN(float64(f))
}

// J0 returns the order-zero Bessel function of the first kind.
func J0[T Rational](x T) float64 {
   return math.J0(float64(x))
}

// J1 returns the order-one Bessel function of the first kind.
func J1[T Rational](x T) float64 {
   return math.J1(float64(x))
}

// Jn returns the order-n Bessel function of the first kind.
func Jn[T1 Rational, T2 Rational](n T1, x T2) float64 {
...
func Tanh[T Rational](x T) float64 {
   return math.Tanh(float64(x))
}

// Y0 returns the order-zero Bessel function of the second kind.
func Y0[T Rational](x T) float64 {
   return math.Y0(float64(x))
}

// Y1 returns the order-one Bessel function of the second kind.
func Y1[T Rational](x T) float64 {
   return math.Y1(float64(x))
}

// Yn returns the order-n Bessel function of the second kind.
func Yn[T1 Rational, T2 Rational](n T1, x T2) float64 {
